...
func BenchmarkSortString1K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	unsorted := make([]string, 1<<10)
	for i := range unsorted {
		unsorted[i] = strconv.Itoa(i ^ 0x2cc)
...
func BenchmarkStableString1K_Slice(b *testing.B) {
	b.StopTimer()
	unsorted := make([]string, 1<<10)
	for i := range unsorted {
		unsorted[i] = strconv.Itoa(i ^ 0x2cc)
...
func BenchmarkStableString1K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	unsorted := make([]string, 1<<10)
	for i := range unsorted {
		unsorted[i] = strconv.Itoa(i ^ 0x2cc)
...
func BenchmarkInt1K_Slice(b *testing.B) {
	b.StopTimer()
...
func BenchmarkInt1K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	unsorted := make([]int, 1<<10)
	for i := range unsorted {
		unsorted[i] = i ^ 0x2cc
...
func BenchmarkStableInt1K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	unsorted := make([]int, 1<<10)
	for i := range unsorted {
		unsorted[i] = i ^ 0x2cc
...
func BenchmarkSortInt64K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	for i := 0; i < b.N; i++ {
		data := make([]int, 1<<16)
		for i := 0; i < len(data); i++ {
...
func BenchmarkStableInt64K_Slice(b *testing.B) {
	b.StopTimer()
	for i := 0; i < b.N; i++ {
		data := make([]int, 1<<16)
		for i := 0; i < len(data); i++ {
...
func BenchmarkStableInt64K_SliceOrdered(b *testing.B) {
	b.StopTimer()
	for i := 0; i < b.N; i++ {
		data := make([]int, 1<<16)
		for i := 0; i < len(data); i++ {
...
func TestSortBM(t *testing.T) {
	testBentleyMcIlroy(t, Sort[*testingData], func(n int) int { return n * lg(n) * 12 / 10 })
}

func TestHeapsortBM(t *testing.T) {
	testBentleyMcIlroy(t, Heapsort[*testingData], func(n int) int { return n * lg(n) * 12 / 10 })
}

func TestStableBM(t *testing.T) {
	testBentleyMcIlroy(t, Stable[*testingData], func(n int) int { return n * lg(n) * lg(n) / 3 })
}
...
func TestCountStableOps(t *testing.T) { countOps(t, Stable[*testingData], "Stable") }
func TestCountSortOps(t *testing.T)   { countOps(t, Sort[*testingData], "Sort  ") }
...
func BenchmarkSort1e2(b *testing.B)   { bench(b, 1e2, Sort[intPairs], "Sort") }
func BenchmarkStable1e2(b *testing.B) { bench(b, 1e2, Stable[intPairs], "Stable") }
func BenchmarkSort1e4(b *testing.B)   { bench(b, 1e4, Sort[intPairs], "Sort") }
func BenchmarkStable1e4(b *testing.B) { bench(b, 1e4, Stable[intPairs], "Stable") }
func BenchmarkSort1e6(b *testing.B)   { bench(b, 1e6, Sort[intPairs], "Sort") }
func BenchmarkStable1e6(b *testing.B) { bench(b, 1e6, Stable[intPairs], "Stable") }
